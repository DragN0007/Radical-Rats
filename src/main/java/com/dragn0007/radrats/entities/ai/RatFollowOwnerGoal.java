package com.dragn0007.radrats.entities.ai;
...
public class RatFollowOwnerGoal extends Goal {
   ...
   public RatFollowOwnerGoal(Rat p_25294_, double v, float p_25296_, float p_25297_, boolean p_25298_) {
